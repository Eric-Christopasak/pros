    ...
    return (
        <div className="container">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 p-3" key={index}>
                        <div className="card">
                            <div className="card-img">
                                <div className="img" style={{ backgroundImage: `url(${Ahood})` }}></div>
                            </div>
            ...
            <div className="row my-5">
                <div className='my-5'>
                    <h1 className='text-center my-2'>Kid's Hoddies</h1>
                </div>
                {[...Array(4)].map((_, index) => (
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 p-3" key={index}>
                        <div className="card">
                            <div className="card-img">
                                <div className="img" style={{ backgroundImage: `url(${hood})` }}></div>
                            </div>
                            <div className="card-title">Product title</div>
                            <div className="card-subtitle">
                                Product description. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
